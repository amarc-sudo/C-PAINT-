...
#define RATIO 1 //ratio de rayon pour tracé cercle

////////////////////////////////////////////////////////////////////////////////
// 0. variables globales et macros
SDL_Surface *rectangle1 = NULL;
SDL_Surface *ecran = NULL;
SDL_Surface *imgcharge = NULL;                 // totalité de l'écran
...
int LARGEURSURFACE = -1;
int HAUTEURSURFACE = -1;
int POSITIONX = -1;
int POSITIONY = -1;
...
// ouvrir une fenêtre de taille largeur (x), hauteur (y) RAJOUT : largeur et hauteur de la surface et ca position
void ouvrir_fenetre(int largeur, int hauteur, int surface_largeur, int surface_hauteur, int positionx, int positiony){

    SDL_Init(SDL_INIT_VIDEO);
    ecran = SDL_SetVideoMode(largeur, hauteur, 32, SDL_HWSURFACE|SDL_DOUBLEBUF );

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/*COMMENTAIRES DU CODE RAJOUTER
	je voulais a tout pris pouvoir avoir la possibilité de sauvegarder mes images, le seul soucis c'est que la libgraphique est vite limité pour des manipulations complexe, donc j'ai décidé de rajouter des briques de codes pour permettre de faire ce que je voulais faire : sauvegarder des images !
	*/
	//je crée une nouvelle surface, rectangle1 car rectangle est déjà utiliser
	rectangle1 = SDL_CreateRGBSurface(SDL_HWSURFACE, surface_largeur, surface_hauteur, 32, 0, 0, 0, 0);
	SDL_Rect positionp;

	//j'initialise leur possition (a changer par des variables)
	positionp.x = positionx;
	positionp.y = positiony;
	//je crée la surface
	SDL_FillRect(rectangle1, NULL, SDL_MapRGB(ecran->format, 255, 255, 255));

	SDL_BlitSurface(rectangle1, NULL, ecran, &positionp);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  LARGEUR = largeur ;
  HAUTEUR = hauteur ;
	LARGEURSURFACE = surface_largeur;
	HAUTEURSURFACE = surface_hauteur;
	POSITIONX = positionx;
	POSITIONY = positiony;
...

//1.2 FONCTION PERSO DE LA LIBGRAPHIQUE

/*
Pour utiliser la fonction SaveBMP de la sdl sela demande de reprendre le contenu d'une surface.
Le seul soucis c'est que dans la libgraphique on peint sur une seul et unique surface, sela n'est pas pratique, Donc j'ai utiliser ma fonction qui permet de sauvegarder une image dans un tableau et de la renvoyer a cette fonction pour enfaite redessiner sur la surface que j'ai crée précédamment.

Cela me permet ensuite de de faire ma propre fonction changer pixel qui va venir colorer sur la surface (qui s'appelle ici rectangle je rappelle)
Une fois cette surface refaite on peut en extraire un image BMP



*/
void enregistre_bmp(int enregistrement[LARGEURSURFACE][HAUTEURSURFACE], char *nom)
{
  int h, l;
	Point coul = {0,0};
	for (h = 0 ; h < 600 ; h ++ )
	{
		for(l = 0 ; l < 800 ; l ++)
		{
			if ((0 <= coul.x) && (coul.x < LARGEUR) && (0 <= coul.y ) && (coul.y < HAUTEUR))
			{
				*( (Uint32*)rectangle1->pixels + coul.y * (rectangle1->pitch / 4) + coul.x ) = enregistrement[l][h] ;
				coul.x++;
			}
		}
	coul.y++;
