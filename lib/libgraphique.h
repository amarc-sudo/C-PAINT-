...
void ouvrir_fenetre(int largeur, int hauteur, int,int,int,int);
...
void enregistre_bmp(int [800][600], char *nom);

//pour transparence
void afficher_image_avec_retour(char *nom, Point coin, int l[]);
////////////////////////////////////////////////////////////////////////////////
